# Calibration report — human vs judge (judge-v4gguf-stock)

Judge run(s): Qwen3.5-4B Q4_K_M GGUF/llama.cpp (no_think=True)

- decisions compared: 63 (+1 human-na excluded, +0 unscored)
- **binary agreement (met vs not-met): 63.5%  (40/63)**
...
### cough_visit · safety_net — human: missed, judge: met (judge over-credits)
...
TIP: Consider explicitly mentioning specific red-flag symptoms (e.g., blood, worsen`
...
- judge evidence: You've got it. And try not to worry — worry's the real enemy here. Book back in whenever you like if you need to, my door's always open.
- judge raw: `RESULT: done
EVIDENCE: "You've got it. And try not to worry — worry's the real enemy here. Book back in whenever you like if you need to, my door's always open."
TIP: None`

### headache_visit · invite_questions — human: partial, judge: met (judge over-credits)
