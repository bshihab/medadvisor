# Blind scoring sheet — h1_stomach
...
```
Dr. Aris: So looking at your chart, you've been having this, uh, sharp pain in your—
Patient: It's actually more of a pressure. Not really sharp, just...
Dr. Aris: Pressure. Okay. And does it usually happen after—
Patient: Like a tight band right here.
Dr. Aris: Right across the ribs?
Patient: No, lower. Like down by my stomach.
Dr. Aris: Oh, the abdomen. Got it. And does eating make it worse, or...?
Patient: Well, if I eat dairy it's bad, but yesterday I just had toast and it still—
Dr. Aris: Wait, just regular toast? No butter?
Patient: Right, dry toast. And it still cramped up.
Dr. Aris: Let's, uh, let me just feel the abdomen really quick. Lean back. Tell me if—
Patient: Oh! Yeah, right there.
Dr. Aris: Right here? Or lower down?
Patient: Mostly right where your hand is, but it kinda shoots—
Dr. Aris: Okay, sit up. Look, it's probably gastritis. Maybe IBS, but sounds like gastritis.
Patient: Gastritis? Is that from stress or—
Dr. Aris: Could be a lot of things. Look, I'm just gonna send in omeprazole for you.
Patient: Oh, okay. Is that a pill, or—
Dr. Aris: Yeah, take it daily. Call us if it gets worse.
Patient: Wait, should I stop eating—
Dr. Aris: Just avoid spicy stuff for a bit. Reception has your paperwork on the way out!
Patient: But—
Dr. Aris: Feel better! Next patient is waiting.
```
...
- [h1_stomach · open_questions] SCORE: ?
...
- [h1_stomach · explore_complaint] SCORE: ?
...
- [h1_stomach · avoid_interrupting] SCORE: ?
...
- [h1_stomach · explore_perspective] SCORE: ?
...
- [h1_stomach · respond_emotion] SCORE: ?
...
- [h1_stomach · support_respect] SCORE: ?
...
- [h1_stomach · plain_language] SCORE: ?
...
- [h1_stomach · accurate_info] SCORE: ?
...
- [h1_stomach · check_understanding] SCORE: ?
...
- [h1_stomach · invite_questions] SCORE: ?
