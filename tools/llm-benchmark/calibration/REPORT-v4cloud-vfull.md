# Calibration report — human vs judge (judge-v4cloud-vfull)
...
- **with verifier: 76.2%  (48/63)** — verifier rejected 5 credits: 3 over-credits fixed, 2 correct credits destroyed

  Correct credits destroyed (recall damage):
  - backpain_visit · plain_language
