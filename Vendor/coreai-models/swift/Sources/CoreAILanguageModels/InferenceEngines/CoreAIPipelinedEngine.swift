    ...
    func generate(
        ...
        let task = Task {
            ...
            do {
                ...
                // MEDADVISOR PATCH: assign AFTER divergence resolution.
                // Upstream set this before the reset, so a diverging request
                // (which reuses nothing) still reported the matched prefix as
                // a cache hit. Here commonPrefix is 0 on the divergence path.
